...
public class EasterEggs {
    public void play(AudioManager manager, MediaPlayer turnUFKMusicDown,Context context){
        if (manager.isMusicActive() && manager.getStreamVolume(AudioManager.STREAM_MUSIC)>=10){
            ...
            Log.d("TAG", "播放且音量大于10时的音量: "+manager.getStreamVolume(AudioManager.STREAM_MUSIC));
